...
class AddCard extends Component {
  ...
  handleAddOnclick = () =>
    this.props.dispatch(
      actionsPersonalData.AddItemFoodSet(
        ...
        Object.keys(this.props.caloriesByMealType)[this.props.mealTypeSelected],
  ...
  render() {
    ...
    if (this.props.itemFoodSelected != null)
      grams = parseInt(
        (1 / this.props.itemFoodSelected.serving_qty) * this.props.itemFoodSelected.serving_weight_grams * this.props.servingSize
      );
              ...
              {!this.props.loadingAdd && (
                <div className="AddCard">
                  <div className="AddCardHeader d-flex justify-content-between">
                    <div>
                      <Image className="AddCardImage" src={this.props.itemFoodSelected.photo.thumb} />
                      <div className="AddCardTitle">{capitalize(this.props.itemFoodSelected.food_name)}</div>
                      <div className="AddCardSubtitle">
                        {this.props.itemFoodSelected.brand_name ? capitalize(this.props.itemFoodSelected.brand_name) : null}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="AddCardFooter">
                      ...
                      <Dropdown>
                        ...
                        <Dropdown.Menu>
                          {Object.keys(this.props.caloriesByMealType).map((key, i) => {
                            return (
                              <Dropdown.Item key={i} as="button" onClick={() => this.handleOnclick(i)}>
                                {capitalize(key)}
                              </Dropdown.Item>
                            );
                          })}
                    ...
                    <div className="text-right mt-3">
                      <Button
                        ...
                        disabled={this.props.servingSize === 0 || this.props.servingSize === "0.00"}
                      >
                        ADD
                      </Button>
                    </div>
