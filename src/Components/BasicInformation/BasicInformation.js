      ...
      <React.Fragment>
        {this.props.isMobile ? (
          <div className="d-flex BasicInformationMobile noselect">
            ...
            <div className="BasicInformationName mr-auto p-2">{this.props.personal.first_name}</div>
            <div className="p-2">
          ...
          <div className="BasicInformation noselect">
            ...
            <div className="PersonalPanelName">{`${this.props.personal.first_name} ${this.props.personal.last_name}`}</div>
          </div>
        )}
      </React.Fragment>
    );
